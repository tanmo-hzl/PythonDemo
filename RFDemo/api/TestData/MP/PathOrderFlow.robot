...
${mik-checkout-pre-initiate}        /cpm/v2/checkout/pre-initiate
${mik-split-order-and-initiate}     /cpm/v2/checkout/split-order-and-initiate
...
${mik-buyer-aftersale-checkorder}   /moh/afterSales/order/v2/checkOrder
...
${mik-seller-export-orders}                /order/export/allOrders

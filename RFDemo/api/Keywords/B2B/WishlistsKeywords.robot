...
Add User Wishlists - POST
    ...
    ${res}    Send Post Request    ${URL-B2B-CPM}    ${USER_WISHLISTS_PATH}    ${body}    ${Headers_Michaels_Post}
...
Update Wishlists Name - PUT
    ...
    ${res}    Send Put Request    ${URL-B2B-CPM}    ${USER_WISHLISTS_PATH}/${WishList_Id}    ${body}    ${Headers_Michaels_Post}
...
Add Items To Wishlists - POST
    ...
    ${res}    Send Post Request    ${URL-B2B-CPM}    ${USER_WISHLISTS_PATH}/${WishList_Id}${WISHLIST_ITEMS}    ${body}    ${Headers_Michaels_Post}
...
Remove Items From Wishlists - DELETE
    ...
    ${res}    Send Delete Request - Params    ${URL-B2B-CPM}    ${USER_WISHLISTS_PATH}/${WishList_Id}${WISHLIST_ITEMS}    ${body}    ${Headers_Michaels_Post}    204

Remove Wishlists - DELETE
    ${res}    Send Delete Request    ${URL-B2B-CPM}    ${USER_WISHLISTS_PATH}/${WishList_Id}    ${NULL}    ${Headers_Michaels_Post}    204

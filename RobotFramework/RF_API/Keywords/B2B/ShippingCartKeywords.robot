...
Get User Shipping Cart Info - GET
    ...
    ${res}    Send Get Request     ${URL-CPM}    ${CARTS}    ${body}    ${Headers_User_Get}
...
Get Shipping Cart Items - GET
    ${res}    Send Get Request    ${URL-CPM}    ${CARTS}/${User_Cart_Id}${CART_ITEMS}    ${null}    ${Headers_User_Get}
...
Add Items To Shipping Carts By SkuNumber- POST
    ...
    ${res}    Send Post Request    ${URL-CPM}    ${CARTS}/${User_Cart_Id}${CART_ITEMS}    ${body}    ${Headers_User_Post}
    Set Suite Variable    ${Shipping_Cart_Items}    ${res.json()}
...
Update Shpping Cart Item's Quantity - PUT
    ...
    ${res}    Send Put Request    ${URL-CPM}     ${path}   ${body}    ${Headers_User_Post}

Remove Items From Shipping Cart By Id- DELETE
    ${path}    Set Variable    ${CARTS}/${User_Cart_Id}${CART_ITEMS}/${Shipping_Item_Id}
    ${res}    Send Delete Request    ${URL-CPM}     ${path}   ${null}    ${Headers_User_Post}    204
...
Request Remove All Items Form Shipping Cart
    ...
    ${res}    Send Delete Request - Params    ${URL-CPM}     ${path}   ${body}    ${Headers_User_Get}    204

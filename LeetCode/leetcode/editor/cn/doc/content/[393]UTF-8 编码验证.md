...
<pre>
<span><code>      </code></span>Number of Bytes<span><code>  |        UTF-8 octet sequence
                       |              (binary)
   --------------------+---------------------------------------------
            1          | 0xxxxxxx
            2          | 110xxxxx 10xxxxxx
...
<div><div>Related Topics</div><div><li>位运算</li><li>数组</li></div></div><br><div><li>👍 190</li><li>👎 0</li></div>